...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera = class ThirdPersonCamera extends gdjs.RuntimeBehavior {
  ...
  updateFromBehaviorData(oldBehaviorData, newBehaviorData) {
    ...
    if (oldBehaviorData.ElevationHalfwayDuration !== newBehaviorData.ElevationHalfwayDuration)
      this._behaviorData.ElevationHalfwayDuration = newBehaviorData.ElevationHalfwayDuration;
    ...
    if (oldBehaviorData.ElevationLogSpeed !== newBehaviorData.ElevationLogSpeed)
      this._behaviorData.ElevationLogSpeed = newBehaviorData.ElevationLogSpeed;
    ...
    if (oldBehaviorData.IsElevatingWithObject !== newBehaviorData.IsElevatingWithObject)
      this._behaviorData.IsElevatingWithObject = newBehaviorData.IsElevatingWithObject;
    if (oldBehaviorData.RotationMode !== newBehaviorData.RotationMode)
      this._behaviorData.RotationMode = newBehaviorData.RotationMode;
    ...
    if (oldBehaviorData.TargetedElevationAngle !== newBehaviorData.TargetedElevationAngle)
      this._behaviorData.TargetedElevationAngle = newBehaviorData.TargetedElevationAngle;
    if (oldBehaviorData.ForwardX !== newBehaviorData.ForwardX)
      this._behaviorData.ForwardX = newBehaviorData.ForwardX;
    if (oldBehaviorData.ForwardY !== newBehaviorData.ForwardY)
      this._behaviorData.ForwardY = newBehaviorData.ForwardY;
    if (oldBehaviorData.ForwardZ !== newBehaviorData.ForwardZ)
      this._behaviorData.ForwardZ = newBehaviorData.ForwardZ;
...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.onCreatedContext.userFunc0x96f728 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const { CameraLocalBasis, ObjectLocalBasis } = gdjs.__thirdPersonCameraExtension;
const object = objects[0];
const behavior = object.getBehavior(eventsFunctionContext.getBehaviorName("Behavior"));
behavior.__thirdPersonCameraExtension = {
    cameraLocalBasis: new CameraLocalBasis(object),
    objectlocalBasis: new ObjectLocalBasis(object)
};
};
...
const objects = gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.onCreatedContext.GDObjectObjects1;
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.onCreatedContext.userFunc0x96f728(runtimeScene, objects, eventsFunctionContext);
...
{for(var i = 0, len = gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.DoMoveCameraCloserContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.DoMoveCameraCloserContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior")).UpdateLocalBasis(eventsFunctionContext);
}
}
{for(var i = 0, len = gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.DoMoveCameraCloserContext.GDObjectObjects1.length ;i < len;++i) {
...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.SlerpContext.userFunc0x1265d70 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.SlerpContext.userFunc0x1265d70(runtimeScene, objects, eventsFunctionContext);
...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.MoveToObjectContext.userFunc0x1344a10 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
/** @type {gdjs.RuntimeObject3D} */
const object = objects[0];
const behavior = object.getBehavior(eventsFunctionContext.getBehaviorName("Behavior"));
const localOffsetX = eventsFunctionContext.getArgument("LocalOffsetX");
const localOffsetY = eventsFunctionContext.getArgument("LocalOffsetY");
const localOffsetZ = eventsFunctionContext.getArgument("LocalOffsetZ");

const layer = object.getInstanceContainer().getLayer(object.getLayer());

const { objectlocalBasis } = behavior.__thirdPersonCameraExtension;
/** @type {{forward: THREE.Vector3, up: THREE.Vector3, right: THREE.Vector3 }} */
const { forward, up, right } = objectlocalBasis;

layer.setCameraX(object.getCenterXInScene() + localOffsetX * right.x + localOffsetY * forward.x + localOffsetZ * up.x);
layer.setCameraY(object.getCenterYInScene() + localOffsetX * right.y + localOffsetY * forward.y + localOffsetZ * up.y);
layer.setCameraZ(object.getCenterZInScene() + localOffsetX * right.z + localOffsetY * forward.z + localOffsetZ * up.z);
...
const objects = gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.MoveToObjectContext.GDObjectObjects1;
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.MoveToObjectContext.userFunc0x1344a10(runtimeScene, objects, eventsFunctionContext);
...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext = {};
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.idToCallbackMap = new Map();
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.GDObjectObjects1= [];


gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.userFunc0xa23120 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const object = objects[0];
const behavior = object.getBehavior(eventsFunctionContext.getBehaviorName("Behavior"));
const { cameraLocalBasis, objectlocalBasis } = behavior.__thirdPersonCameraExtension;
cameraLocalBasis.update();
objectlocalBasis.update();
behavior._setForwardX(cameraLocalBasis.forward.x);
behavior._setForwardY(cameraLocalBasis.forward.y);
behavior._setForwardZ(cameraLocalBasis.forward.z);

};
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.eventsList0 = function(runtimeScene, eventsFunctionContext) {

{

gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.GDObjectObjects1);

const objects = gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.GDObjectObjects1;
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.userFunc0xa23120(runtimeScene, objects, eventsFunctionContext);
...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasis = function(parentEventsFunctionContext) {
...
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.GDObjectObjects1.length = 0;

gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.eventsList0(runtimeScene, eventsFunctionContext);
gdjs.evtsExt__ThirdPersonCamera__ThirdPersonCamera.ThirdPersonCamera.prototype.UpdateLocalBasisContext.GDObjectObjects1.length = 0;
